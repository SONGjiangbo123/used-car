<template>
    <div class="bodyB">
        ...
        <div class="right">
            ...
            <!-- 价格 -->
            <Optionkuai class="js-filter-price" :listtitle="price" :title="prices"></Optionkuai>
            <!-- 自定义价格 -->
            <div class="right_class_pp_zdyjg right_class_pp_right_zdyjg">
            ...
            <!-- 首付 -->
            <Optionkuai class="js-filter-price" :listtitle="putdown" :title="putdowns"></Optionkuai>
            <!-- 自定义首付 -->
            <div class="right_class_pp_zdyjg right_class_pp_right_zdyjg">
                <span class="right_class_pp_zdyjg_title">
                    <span>自定义首付</span>
            ...
            <!-- 月供 -->
            <Optionkuai class="js-filter-price" :listtitle="monthly" :title="monthlys"></Optionkuai>
            <!-- 自定义月供 -->
            <div class="right_class_pp_zdyjg right_class_pp_right_zdyjg">
                <span class="right_class_pp_zdyjg_title">
                    <span>自定义月供</span>
            ...
            <!-- 车源类型 -->
            <Optionkuai class="js-filter-price" :listtitle="type" :title="types" :more="mores"></Optionkuai>
            <!-- 变速箱 -->
            <Optionkuai class="js-filter-price" :listtitle="gearbox" :title="gearboxs"></Optionkuai>
            <!-- 车龄 -->
             <div class="right_class_pp_zdyjg right_class_pp_right_zdyjg">
                <span class="right_class_pp_zdyjg_title">
                    <span>车龄</span>
            ...
            <!-- 发动机 -->
            <Optionthreekuai class="js-filter-price" :listtitle="engine" :title="engines"></Optionthreekuai>
            <!-- 排放标准 -->
            <Optionkuai class="js-filter-price" :listtitle="emission" :title="emissions"></Optionkuai>
            <!-- 颜色 -->
            <Optioncolor></Optioncolor>
            <!-- 燃料类型 -->
            <Optionthreekuai class="js-filter-price" :listtitle="Fueltype" :title="Fueltypes"></Optionthreekuai>
            <!-- 厂商类型 -->
            <Optionkuai class="js-filter-price" :listtitle="genre" :title="genres"></Optionkuai>
            <!-- 座位数 -->
            <Optionkuai class="js-filter-price" :listtitle="seating" :title="seatings"></Optionkuai>
            <!-- 国别 -->
            <Optionthreekuai class="js-filter-price" :listtitle="nationality" :title="nationalitys"></Optionthreekuai>
            <!-- 驱动 -->
            <Optionthreekuai class="js-filter-price" :listtitle="drive" :title="drives"></Optionthreekuai>
            <!-- 配置亮点 -->
            <Optionkuai class="js-filter-price" :listtitle="configuration" :title="configurations" :more="mores"></Optionkuai>
        </div> 
    </div>
</template>
<script>
